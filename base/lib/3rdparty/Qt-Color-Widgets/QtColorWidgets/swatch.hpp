...
public:
  ...
  void paletteChanged(const ColorPalette& palette)
      W_SIGNAL(paletteChanged, palette);
...
protected:
  ...
  W_PROPERTY(
      int,
      selected READ selected WRITE setSelected NOTIFY selectedChanged)
  ...
  W_PROPERTY(
      QPen,
      selection READ selection WRITE setSelection NOTIFY selectionChanged)
  ...
  W_PROPERTY(
      QColor,
      emptyColor READ emptyColor WRITE setEmptyColor NOTIFY emptyColorChanged)

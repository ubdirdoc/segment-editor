...
void ColorWheel::paintEvent(QPaintEvent*)
{
  ...
  painter.drawImage(
      QRectF(QPointF(0, 0), p->selector_size()), p->inner_selector);
...
void ColorWheel::mouseMoveEvent(QMouseEvent* ev)
{
  ...
  else if (p->mouse_status == DragSquare)
  {
    ...
    QLineF center_mouse_ln(
        QPointF(0, 0), glob_mouse_ln.p2() - glob_mouse_ln.p1());

    center_mouse_ln.setAngle(
        center_mouse_ln.angle() + p->selector_image_angle());

    ...
    const score::ApplicationContext& ctx, const score::InterfaceKey& key) const
{
  return instantiate_factories<
      ...
      SEGMent::SceneInspectorFactory, SEGMent::ImageInspectorFactory,
      SEGMent::GifInspectorFactory, SEGMent::TransitionInspectorFactory,
      SEGMent::TextInspectorFactory, SEGMent::ClickInspectorFactory, SEGMent::BackClickInspectorFactory
      >,
...
iscore_addon_SEGMent::make_commands()
{
  ...
  // CMake generates the "iscore_addon_SEGMent_commands.hpp" and "iscore_addon_SEGMent_commands_files.hpp"

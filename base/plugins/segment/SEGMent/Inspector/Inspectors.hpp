...
{
public:
  SceneInspector(const SceneModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
...
{
public:
  ImageInspector(const ImageModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
    auto lay = new Inspector::Layout{this};
...
{
public:
  GifInspector(const GifModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
    ...
    auto f = WidgetFactory<GifModel::p_frames, GifModel>{sc, doc, *lay, this}.make(sc.frames());
...
{
public:
  TransitionInspector(const TransitionModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
    auto lay = new Inspector::Layout{this};
...
{
public:
  ClickInspector(const ClickAreaModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
    auto lay = new Inspector::Layout{this};
...
{
public:
  BackClickInspector(const BackClickAreaModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
    auto lay = new Inspector::Layout{this};
...
{
public:
  TextInspector(const TextAreaModel& sc, const score::DocumentContext& doc, QWidget* parent)
    : QWidget{parent}
  {
    auto lay = new Inspector::Layout{this};
...
INSPECTOR_FACTORY(ImageInspectorFactory, ImageModel, ImageInspector, "e3a3d882-549d-46ef-9c2c-336e4893d7b6")
INSPECTOR_FACTORY(GifInspectorFactory, GifModel, GifInspector, "4e379cda-508e-4999-b9da-e76f55cb0e28")
INSPECTOR_FACTORY(SceneInspectorFactory, SceneModel, SceneInspector, "1ca16c0a-6c01-4054-a646-d860a3886e81")
INSPECTOR_FACTORY(TransitionInspectorFactory, TransitionModel, TransitionInspector, "48e36531-9477-4d77-bdc3-b5594c06b505")
INSPECTOR_FACTORY(ClickInspectorFactory, ClickAreaModel, ClickInspector, "556bf888-3e25-4b2d-a5a3-1b6b987cb1f7")
INSPECTOR_FACTORY(BackClickInspectorFactory, BackClickAreaModel, BackClickInspector, "8522cee8-08b8-4055-82fa-560f8ddfca5f")
INSPECTOR_FACTORY(TextInspectorFactory, TextAreaModel, TextInspector, "3be4a8c2-6b2e-49dc-896e-b0f357be5f66")
